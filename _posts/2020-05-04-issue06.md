...
```javascript
{
  ...
  "repository": {
    "type": "git",
    "url": "git+https://bowaxwing@bitbucket.org/11st_js/fe-build.git"
  },
  "author": "",
  "license": "MIT",
  "homepage": "https://bitbucket.org/11st_js/fe-build#readme",
  "devDependencies": {
    "@babel/core": "^7.9.0",
...
[링크](https://github.com/hyungju-lee/hyungju-lee/blob/master/00_issue/daily/00_gulpfile_phpServer_browswerSyncReload2/scss-minimal.handlebars)